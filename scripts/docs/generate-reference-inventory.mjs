...
const excludedErrorInventoryLiterals = new Set([
  ...
  "procedure_resolver_views",
  "procedures_revisited",
  "project_cache_hits",
  "project_cache_misses",
  "project_cache_rebuilds",
  "project_cache_reused_entries",
  "project_dependency_invalidations",
  "project_snapshot_builds",
  "resolution_materializations",
  "resolution_overlay_builds",
