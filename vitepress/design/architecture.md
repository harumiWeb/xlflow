...
xlflow is a Windows-first Go CLI using Cobra for command routing, `xlflow.toml` for project configuration, stable JSON envelopes for automation, and PowerShell scripts for Excel COM and VBIDE operations.

Key decisions:

- Excel-dependent commands require Windows, Excel, PowerShell, and VBIDE trust settings.
