...
Safety diagnostics `VB008` through `VB014`, `VB028`, and `VB029` are always enabled and cannot be suppressed inline because they prevent VBE compile dialogs before `push` or `run` opens Excel.
