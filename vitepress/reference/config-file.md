...
Safety diagnostics `VB008` through `VB014`, `VB028`, `VB029`, `VB031`, and `VB032` are always enabled and cannot be disabled with `disabled_rules`.
...
Preflight-blocking lint diagnostics `VB008` through `VB014`, `VB028`, `VB029`, `VB031`, and `VB032` cannot be suppressed inline.
