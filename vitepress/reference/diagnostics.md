...
| Precision                   | `high`                                  |
| Enabled by default          | no                                      |
| Configuration               | `detect_public_member_underscore_names` |
| Inline suppression          | yes                                     |
| Blocks source preflight     | no                                      |
| Real-time editor diagnostic | yes                                     |
| Fix available               | no                                      |
...
| Precision                   | `high`                               |
| Enabled by default          | no                                   |
| Configuration               | `detect_document_module_public_enum` |
| Inline suppression          | yes                                  |
| Blocks source preflight     | no                                   |
| Real-time editor diagnostic | yes                                  |
| Fix available               | no                                   |
...
| Precision                   | `high`                       |
| Enabled by default          | no                           |
| Configuration               | `detect_write_only_property` |
| Inline suppression          | yes                          |
| Blocks source preflight     | no                           |
| Real-time editor diagnostic | yes                          |
| Fix available               | no                           |
...
| Precision                   | `high`                                  |
| Enabled by default          | no                                      |
| Configuration               | `detect_public_interface_event_members` |
| Inline suppression          | yes                                     |
| Blocks source preflight     | no                                      |
| Real-time editor diagnostic | yes                                     |
| Fix available               | no                                      |
...
| Precision                   | `high`                               |
| Enabled by default          | no                                   |
| Configuration               | `detect_predeclared_instance_access` |
| Inline suppression          | yes                                  |
| Blocks source preflight     | no                                   |
| Real-time editor diagnostic | yes                                  |
| Fix available               | no                                   |
