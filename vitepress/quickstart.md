...
Use `xlflow new MyAddin.xlam` when the managed file should be an Excel add-in, or `xlflow new LargeModel.xlsb` when it should be an Excel Binary Workbook instead of the default `.xlsm` workbook.
