...
A UserForm-based game that demonstrates form workflows and runtime image verification.

![Invader Game](/images/space-invader.gif)

View the sample project on GitHub:
[example/space-invader](https://github.com/harumiWeb/xlflow/tree/main/example/space-invader)

<!-- xlflow-demo-case-study -->

## What it does

Invader Game is a small workbook application that can be inspected, executed, and reviewed as source.

## Why it is a useful xlflow example

It demonstrates UserForm event handlers, timer cleanup, and interactive visual verification.
