...
func TestDomainAndCounterNamesAreStable(t *testing.T) {
	...
	plannerCounterNames := []struct {
		...
		{CounterGenericDataflowPlannedRuns, GenericDataflowPlannedRunsCounter},
		{CounterGenericDataflowSkippedRuns, GenericDataflowSkippedRunsCounter},
		{CounterHTTPDataflowPlannedRuns, HTTPDataflowPlannedRunsCounter},
		{CounterHTTPDataflowSkippedRuns, HTTPDataflowSkippedRunsCounter},
		{CounterGenericDataflowKernelRuns, GenericDataflowKernelRunsCounter},
		{CounterHTTPDataflowKernelRuns, HTTPDataflowKernelRunsCounter},
		{CounterGenericDataflowCFGWalks, GenericDataflowCFGWalksCounter},
		{CounterHTTPDataflowCFGWalks, HTTPDataflowCFGWalksCounter},
