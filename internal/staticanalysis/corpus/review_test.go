...
func TestCommittedDiagnosticReviews(t *testing.T) {
	...
	if len(reviews) != 3385 {
		t.Fatalf("committed reviews = %d, want 3385", len(reviews))
	}
...
func TestCommittedCorpusReviewMetrics(t *testing.T) {
	...
	if metrics.Reviewed != 3653 || metrics.TP != 2357 || metrics.FP != 1296 {
		t.Fatalf("committed review metrics = %#v, want Reviewed=3653 TP=2357 FP=1296", metrics)
	}
	// This review pass expanded the ledger with confirmed VB001, VB004, VB005, VB006, VB007, VB020, VB045, and VBA206
