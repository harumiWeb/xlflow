...
func TestCommittedDiagnosticReviews(t *testing.T) {
	...
	if len(reviews) != 3993 {
		t.Fatalf("committed reviews = %d, want 3993", len(reviews))
	}
...
func TestCommittedCorpusReviewMetrics(t *testing.T) {
	...
	if metrics.Reviewed != 4253 || metrics.TP != 2738 || metrics.FP != 1515 {
		t.Fatalf("committed review metrics = %#v, want Reviewed=4253 TP=2738 FP=1515", metrics)
	}
	// This review pass expanded the ledger with confirmed VB001, VB004, VB005, VB006, VB007, VB020, VB045, VBA202, VBA204, VBA206, VBA225, VBA227, VBA237, VBA241, VBA244, and VBA245
