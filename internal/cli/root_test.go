...
func TestWriteAnalyzePerformanceReportsWorkloadCounters(t *testing.T) {
	...
	for _, name := range []string{
		...
		"array_interprocedural_cfg_walks", "array_worklist_revisits",
	...
	for _, expected := range []string{
		...
		`counter="array_participant_procedures"`,
		...
		`counter="array_interprocedural_cfg_walks"`, `counter="array_worklist_revisits"`,
