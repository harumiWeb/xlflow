...
func TestFormulasPullWritesStableSnapshotsAndRemovesStaleOutput(t *testing.T) {
	...
	for _, want := range []string{
		`"range":"C2:C4","kind":"shared","shared_index":"0","anchor":"C2","formula_r1c1":"=RC[-2]*RC[-1]"`,
		`"range":"G2:G3","kind":"normal","formula_r1c1":"=RC[-2]*RC[-1]"`,
		`"range":"G4","kind":"normal","formula":"=Table1[Amount]","example_cell":"G4","example_formula":"=Table1[Amount]","count":1,"parse_status":"partial","features":["structured_reference"]`,
	} {
