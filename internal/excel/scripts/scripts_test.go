...
func TestPowerShellScriptsParse(t *testing.T) {
	scripts := []string{"attach.ps1", "common.ps1", "doctor.ps1", "edit.ps1", "export-image.ps1", "form-export-image.ps1", "form-write.ps1", "inspect-form.ps1", "inspect.ps1", "list.ps1", "macros.ps1", "new.ps1", "process.ps1", "pull.ps1", "push.ps1", "run.ps1", "runner.ps1", "session.ps1", "test.ps1", "ui.ps1"}
