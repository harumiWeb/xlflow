...
- Treat `src/forms/specs/*.yaml` as the canonical source-controlled artifact for UserForm design. `.frm` / `.frx` are build or pull artifacts, not the primary source of truth for Designer behavior.
