...
7. テストがない場合は xlflow macros --json → xlflow run <qualified_name> --json を実行する
8. 実行時エラーが分かりにくい場合は xlflow trace inject → xlflow run --trace --json を使う
