...
Stable analyzer codes include existing `VBA101` through `VBA106` plus runtime-risk `VBA201` through `VBA213`.
...
- Tests: analyzer regression tests for `VBA101` through `VBA106` and runtime-risk tests for `VBA201` through `VBA213`.
