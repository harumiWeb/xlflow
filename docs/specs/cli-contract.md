...
xlflow [--json] run [macro] [--input <workbook>] [--arg <type:value>]... [--msgbox <dialog-id=result>]... [--inputbox <dialog-id=value>]... [--save | --save-as <path>] [--trace] [--headless | --interactive] [--direct] [--fast] [--diagnostic] [--session] [--timeout <duration>] [--keepalive] [--keepalive-interval <duration>]
...
xlflow [--json] test [--filter <name>] [--msgbox <dialog-id=result>]... [--inputbox <dialog-id=value>]... [--session] [--keepalive] [--keepalive-interval <duration>]
