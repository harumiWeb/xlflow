...
- `VBA201`: a result from a receiver resolved as `Excel.Range.Find` is dereferenced before a `Nothing` check; project-defined or unresolved `.Find` methods are excluded
