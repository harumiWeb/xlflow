...
the opt-in `VBA259` select-case reachability rule and the `VBA260`–`VBA262`
Excel semantic inspections extend it further, and the unused-declaration
expansion extends it through `VBA269`: `VBA265` reports unread
